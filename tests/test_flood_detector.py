...
from shieldgram.config import FloodDetectorConfig
from shieldgram.detectors.flood_detector import FloodDetector
...
class TestFloodDetector:
    ...
    async def test_detects_burst(self, redis_storage: RedisStorage) -> None:
        config = FloodDetectorConfig(
